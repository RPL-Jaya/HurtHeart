...
from .views import psikiater_detail, psikiater_detail_api, psikiater_list, psikiater_list_api, jadwal_konsultasi_psikiater
...
urlpatterns = [
    ...
    path('jadwal_konsultasi/', jadwal_konsultasi_psikiater, name='jadwal_konsultasi_psikiater'),
